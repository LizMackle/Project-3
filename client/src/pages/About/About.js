          ...
          <div className="row h-100 text-center py-5">
            <div className="col-lg-12">
              ...
              <p className="about-text mb-0 mt-3">
                ...
                the world. This allows users to share their experience about a
                holiday destination that they have visited by simply clicking a
                location on the map and adding their review and star rating.
                This generates a pin drop that provides easy access when
                returning back to view existing reviews.
              </p>
            </div>
          </div>
        </div>
